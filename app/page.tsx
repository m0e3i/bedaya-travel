        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <SignInButton mode="modal">
              <button className="bg-slate-800 hover:bg-slate-700 text-white border border-[#19B5A5] px-4 py-2 rounded-full font-semibold transition text-sm">
                تسجيل الدخول
              </button>
            </SignInButton>
            ...
            <a 
              ...
              className="bg-[#19B5A5] text-white px-5 py-2 rounded-full font-semibold hover:bg-[#148f83] transition shadow text-center text-sm"
            >
              احجز رحلتك الآن
            </a>
          </div>
